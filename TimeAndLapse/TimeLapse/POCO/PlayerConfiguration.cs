...
namespace TimeLapse.POCO
{
    ...
    public partial class PlayerConfiguration : EntityTypeConfiguration<Player>
    {
        ...
        public PlayerConfiguration(string schema)
        {
            ...
            // Foreign keys
            HasRequired(a => a.Event).WithMany(b => b.Players).HasForeignKey(c => c.EventId); // FK__Players__EventID__4316F928
            HasRequired(a => a.Player_CrewId).WithMany(b => b.Players).HasForeignKey(c => c.CrewId); // FK__Players__CrewID__4222D4EF
            HasRequired(a => a.Registration).WithMany(b => b.Players).HasForeignKey(c => c.RegistrationId); // FK__Players__Registr__403A8C7D
            HasRequired(a => a.Team).WithMany(b => b.Players).HasForeignKey(c => c.TeamId); // FK__Players__TeamID__412EB0B6
            InitializePartial();
        }
