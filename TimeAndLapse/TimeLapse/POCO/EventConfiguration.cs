...
namespace TimeLapse.POCO
{
    ...
    public partial class EventConfiguration : EntityTypeConfiguration<Event>
    {
        ...
        public EventConfiguration(string schema)
        {
            ...
            // Foreign keys
            HasRequired(a => a.Category).WithMany(b => b.Events).HasForeignKey(c => c.CategoryId); // FK__Events__Category__44FF419A
            HasRequired(a => a.Championship).WithMany(b => b.Events).HasForeignKey(c => c.ChampionshipId); // FK__Events__Champion__45F365D3
            HasRequired(a => a.Race).WithMany(b => b.Events).HasForeignKey(c => c.RaceId); // FK__Events__RaceID__440B1D61
            InitializePartial();
        }
