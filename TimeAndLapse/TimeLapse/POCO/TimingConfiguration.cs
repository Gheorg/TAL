...
namespace TimeLapse.POCO
{
    ...
    public partial class TimingConfiguration : EntityTypeConfiguration<Timing>
    {
        ...
        public TimingConfiguration(string schema)
        {
            ...
            // Foreign keys
            HasRequired(a => a.Run).WithMany(b => b.Timings).HasForeignKey(c => c.RunId); // FK__Timings__RunID__46E78A0C
            HasRequired(a => a.TimingType).WithMany(b => b.Timings).HasForeignKey(c => c.TimingTypeId); // FK__Timings__TimingT__47DBAE45
            InitializePartial();
        }
